...
let UserService = class UserService {
    ...
    getUsers(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userModel.find(query).select('-local.salt  -local.hashedPassword');
        });
    }
    updateProfileImage(user, file) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log('called here');
            user.avatar = file.location || `/${converters_1.parseImageURL(file.path)}`;
            return yield user.save();
        });
    }
    getUserById(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userModel.findById(userId).select('-local.salt -local.hashedPassword');
        });
    }
    deleteUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
