...
const roles_decotator_1 = require("../../decorators/roles.decotator");
...
__decorate([
    common_1.Get('me'),
    roles_decotator_1.Roles('user', 'admin'),
...
__decorate([
    common_1.Get(),
    roles_decotator_1.Roles('user', 'admin', 'superadmin'),
    __param(0, common_1.Req()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    common_1.Delete(':id'),
    roles_decotator_1.Roles('admin', 'superadmin'),
    __param(0, common_1.Req()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
